...
class DiagnosticsParser2021_03_29(HTMLParser):
    HEADERS = [
        "test_id",  # 0
    ...
    def __init__(self):
        ...
        self.number_of_tbody_until_target = 3
    ...
    def handle_starttag(self, tag, attrs):
        if tag == "tbody" and self.state != ParserState.FINISHED:
            self.number_of_tbody_until_target -= 1
            if self.number_of_tbody_until_target == 0:
